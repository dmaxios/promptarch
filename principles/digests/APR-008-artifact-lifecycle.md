...
> **Generated digest of [APR-008 — An Artifact-Lifecycle and Model-Migration Principle for Promptware](../APR-008-artifact-lifecycle.md) v0.2.0.** The full APR is authoritative — read it for motivation, prior art, and worked detail. Do not edit by hand.
...
- **Bidirectional**: eval-calibrated gates (`min_eval_score`, eval-placed approval tiers) SHOULD be re-benchmarked against the new model; loosening a stale over-caution gate MUST be a version-bumped, recorded change. Blast-radius/reversibility oversight placement (APR-009) MUST NOT be loosened on capability grounds.
- A migration is a disciplined, eval-gated, recorded event — never a silent swap, and never a silent accumulation of stale gates.
...
---
*Source: [APR-008 — An Artifact-Lifecycle and Model-Migration Principle for Promptware](../APR-008-artifact-lifecycle.md) v0.2.0 · regenerate this digest whenever the source changes.*
